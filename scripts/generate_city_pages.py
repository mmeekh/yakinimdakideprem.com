...
<head>
    ...
    <title>{name} Son Depremler - Canlı Risk Haritası ve Anlık Veriler</title>
    <meta name="description"
        content="{name} ve çevresinde meydana gelen son depremleri anlık takip edin. {name} deprem riski, fay hattı bilgileri ve hazırlık rehberi.">
    <meta name="keywords"
        content="{name_lower} deprem, son deprem {name_lower}, {region_title_lower} depremi, {name_lower} deprem haritası, afad {name_lower}, kandilli {name_lower}">
...
{place_schema}
    ...
    <link rel="stylesheet" href="css/city-search.css?v=202604172301">
    <script type="application/ld+json">
{breadcrumb_schema}
    </script>
    <style>
...
{neighbors_html}
                ...
                <section>
                    ...
                    <ul>
                        ...
                        <li><a href="/blog-dask-nedir.html" rel="noopener noreferrer">DASK Zorunlu Deprem Sigortasi</a></li>
                    </ul>
                </section>
            </div>
        </article>
    ...
    <script src="js/header.min.js?v=202604173000"></script>
    <script src="js/toc.js?v=202512182020"></script>
    <script src="js/city-keywords.js?v=202604172301"></script>
    <script src="js/city-search.js?v=202604172400" defer></script>
...
def build_schema(province: dict) -> tuple[str, str, str]:
    ...
    article = {
        ...
        "image": {
            "@type": "ImageObject",
            "url": "https://yakinimdakideprem.com/images/og-yakinimdakideprem.png",
            "width": 1200,
            "height": 630,
        },
